...
---
- **08.31**  
   1.【网络】[OSI每一层的作用分别是什么？](https://github.com/Scale-of-evaluation/daily-question/issues/242)   
   2.【数据库】[Redis事务支持隔离性吗？](https://github.com/Scale-of-evaluation/daily-question/issues/243)   
   3.【Linux】[查看各类环境变量用什么命令？](https://github.com/Scale-of-evaluation/daily-question/issues/244)          
   4.【通用基础】[什么是git stash drop？](https://github.com/Scale-of-evaluation/daily-question/issues/245)         
   5.【面试题】[LR自带的例子端口号怎么修改？](https://github.com/Scale-of-evaluation/daily-question/issues/246)   

- **08.30**  
   1.【网络】[请简述B/S软件架构和C/S软件架构](https://github.com/Scale-of-evaluation/daily-question/issues/237)   
   2.【数据库】[在数据库测试中，我们需要正常检查什么？](https://github.com/Scale-of-evaluation/daily-question/issues/238)   
   3.【Linux】[怎么使一个命令在后台运行?](https://github.com/Scale-of-evaluation/daily-question/issues/239)          
   4.【通用基础】[commit 提交对象包含什么？](https://github.com/Scale-of-evaluation/daily-question/issues/240)         
   5.【面试题】[请详细介绍一下各种测试类型的含义](https://github.com/Scale-of-evaluation/daily-question/issues/241)    

- **08.29**  
   1.【网络】[token、session的区别](https://github.com/Scale-of-evaluation/daily-question/issues/232)    
   2.【数据库】[Redis如何做内存优化？](https://github.com/Scale-of-evaluation/daily-question/issues/233)   
   3.【Linux】[Linux 下命令有哪几种可使用的通配符？分别代表什么含义?](https://github.com/Scale-of-evaluation/daily-question/issues/234)       
   4.【通用基础】[什么是SubGit？](https://github.com/Scale-of-evaluation/daily-question/issues/235)          
   5.【面试题】[某人连续打工24天，赚得190元(日工资10元，星期六做半天工，发半天工资；星期日休息，无工资)。已知他打工是从1月下旬的某一天开始的，这个月的1号恰好是星期日。    问：这人打工结束的那一天是2月几日?](https://github.com/Scale-of-evaluation/daily-question/issues/236)     

- **08.28**  
   1.【网络】[怎么解决Http协议无状态协议?](https://github.com/Scale-of-evaluation/daily-question/issues/227)       
   2.【数据库】[Redis的内存用完了会发生什么？](https://github.com/Scale-of-evaluation/daily-question/issues/228)         
   3.【Linux】[查看文件内容有哪些命令可以使用？](https://github.com/Scale-of-evaluation/daily-question/issues/229)     
   4.【通用基础】[描述一下你所使用的分支策略？](https://github.com/Scale-of-evaluation/daily-question/issues/230)            
   5.【面试题】[LoadRunner回放脚本时，在浏览器显示的中文是乱码，如何解决这一问题？](https://github.com/Scale-of-evaluation/daily-question/issues/231)     

- **08.27**  
   1.【网络】[为什么说http协议是无状态协议？](https://github.com/Scale-of-evaluation/daily-question/issues/222)         
   2.【数据库】[Redis主要消耗什么物理资源？](https://github.com/Scale-of-evaluation/daily-question/issues/223)         
   3.【Linux】[绝对路径用什么符号表示？当前目录、上层目录用什么表示？主目录用什么表示? 切换目录用什么命令](https://github.com/Scale-of-evaluation/daily-question/issues/224)       
   4.【通用基础】[如果想要在提交之前运行代码性检查工具，并在测试失败时阻止提交，该怎样配置 Git 存储库？](https://github.com/Scale-of-evaluation/daily-question/issues/225)            
   5.【面试题】[性能测试往往需要准备大批量的数据，大批量数据的生成方法有很多种，常见的有哪几种？](https://github.com/Scale-of-evaluation/daily-question/issues/226)     

- **08.26**  
   1.【网络】[net use和net user 分别指什么？](https://github.com/Scale-of-evaluation/daily-question/issues/217)       
   2.【数据库】[Redis的内存淘汰策略有哪些](https://github.com/Scale-of-evaluation/daily-question/issues/218)       
   3.【Linux】[你的系统目前有许多正在运行的任务，在不重启机器的条件下，有什么方法可以把所有正在运行的进程移除呢？](https://github.com/Scale-of-evaluation/daily-question/issues/219)     
   4.【通用基础】[什么是 Git bisect？如何使用它来确定（回归）错误的来源？](https://github.com/Scale-of-evaluation/daily-question/issues/220)          
   5.【面试题】[怎样做好测试计划？](https://github.com/Scale-of-evaluation/daily-question/issues/221)     

- **08.25**  
   1.【网络】[两台笔记本连起来后ping不通，可能是哪些原因？](https://github.com/Scale-of-evaluation/daily-question/issues/212)      
   2.【数据库】[Mysql数据库utf8mb3与utf8mb4编码的区别](https://github.com/Scale-of-evaluation/daily-question/issues/213)      
   3.【Linux】[Linux如何转换文本文件的编码(比如从GBK转换成UTF8)](https://github.com/Scale-of-evaluation/daily-question/issues/214)      
   4.【通用基础】[git相关：怎样将 N 次提交压缩成一次提交？](https://github.com/Scale-of-evaluation/daily-question/issues/215)      
   5.【面试题】[一个人花8块钱买了一只鸡，9块钱卖掉了，然后他觉得不划算，花10块钱又买回来了，11块卖给另外一个人。问他赚了多少？](https://github.com/Scale-of-evaluation/daily-question/issues/216)  
